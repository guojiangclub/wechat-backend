                ...
                <tbody>
                    <tr>
                        ...
                        <tr  class="tr-show"  style="display:none;"  v-show="events.length"  v-for="(item,index) in events">
                            ...
                            <td v-show="keybtn[item.id]">{#decodeURI(item.value)#}</td>
                            <td v-show="keybtn[item.id]">{#item.updated_at#}</td>
                            <td v-show="keybtn[item.id]" >
                                <span class="btn btn-xs btn-primary">
                                    <i data-toggle="tooltip" data-placement="top" class="fa fa-pencil-square-o" title="" @click="Edit(item.id,1)"  data-original-title="编辑"></i></span>
