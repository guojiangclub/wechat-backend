                    ...
                    <div class="panel-body">
                        <div class="hint" style="margin-left:30px;" >
                            <p>
                                ...
                                2.图文内容上传的图片会自动同步到微信服务器，请勿使用过大的图片；
                            </p>
                        </div>
                                ...
                                <div class="material_form ">
                                        ...
                                        <div   v-if="add.length"   v-for="(item,index) in add" class="appmsg_sub_item edit_item" style="height:110px;" data-form="item">
                                            ...
                                            <div >
                                                ...
                                                <div class="hover_area"><a href="javascript:;" @click="editMag(form[item].index,index)">编辑</a>
                                                    <a href="javascript:;"   @click="Delete(item,index)">删除</a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="edit_area" style="width:600px;display: none">
                                        ...
                                        <ul class="tab-pane in appmsg_edit_group">
                                            ...
                                            <li id="app" class="form-item cf form-group" style="position: relative">
                                                <div class="col-sm-9 controls" style="position: absolute;top: -50px;left:250px;">
                                                    <input type="button" @click="getData()" data-toggle="modal" data-target="#imgModal"  class="btn btn-primary" value="图片素材" style="margin-left:75px;">
    ...
    <script>
        $(function(){
            ...
            setTimeout("$('.edit_area').show();",1000);
            $('.tab-content').show();
            UEObj=ue;
    ...
    <script>
        new Vue({
            ...
            data:{
                ...
                form:[
                    {index:0,title:"这是标题",author:'',description:'',content:'',cover_media_id:'',content_url:'',img:'',show_cover:0},
                    {index:1,title:"",author:'',description:'',content:'',cover_media_id:'',content_url:'',img:'',show_cover:0},
                    {index:2,title:"",author:'',description:'',content:'',cover_media_id:'',content_url:'',img:'',show_cover:0},
                    {index:3,title:"",author:'',description:'',content:'',cover_media_id:'',content_url:'',img:'',show_cover:0},
                    {index:4,title:"",author:'',description:'',content:'',cover_media_id:'',content_url:'',img:'',show_cover:0},
                    {index:5,title:"",author:'',description:'',content:'',cover_media_id:'',content_url:'',img:'',show_cover:0},
                    {index:6,title:"",author:'',description:'',content:'',cover_media_id:'',content_url:'',img:'',show_cover:0},
                    {index:7,title:"",author:'',description:'',content:'',cover_media_id:'',content_url:'',img:'',show_cover:0},
                ],

                show_data:{
                    id:0,title:"这是标题",author:'',description:'',content:'',cover_media_id:'',content_url:'',img:'',show_cover:0,
                }
            ...
            methods:{
               ...
               addMsg:function(){
                ...
                editMag:function (p,key) {
                    ...
                    this.show_data={
                        id:0,title:data.title,author:data.author,description:data.description,content:data.content,cover_media_id:data.cover_media_id,content_url:data.content_url,img:data.img,show_cover:data.show_cover,
                    }
