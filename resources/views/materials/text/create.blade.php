                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <div class="emoji emoji-airplane"></div>
                                    <textarea   id="question"   class="form-control emojiable-question"  name="content" rows="15"></textarea>
                            </div>
                        </div>
...
@section('after-scripts-end')--}}
    ...
    <script type="text/javascript">
        ...
        $('#uping').on('click',function(){
            ...
            $.ajax({
                type:"post",
                url:"{{route('admin.wechat.material.store_text')}}",
                data:{'_token':_token,content:content,'type':'text'},
