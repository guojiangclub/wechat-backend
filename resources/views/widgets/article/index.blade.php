...
<div style="width:300px;margin-top:50px;" id="showArticle-box" v-show="type=='article'&&data_img&&data_title&&selected?true:false">
    <div class="data-show-article data-show"  style="display:none;position:relative;border: 1px dashed #CCCCCC;">
