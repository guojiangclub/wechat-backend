...
<div class="col-sm-9" style="margin-top:15px;" id="showImg-box"  v-show="type=='image'&&data_img&&selected?true:false">
    <div style="display: none;position:relative" class="data-show-image data-show">
            ...
            <div class="modal-body" style="margin-top: 20px;">
                <div class="have-material clearfix">
                    ...
                    <div class="col-sm-3">
                        ...
                        <div id="upload-img" style="margin-top: 20px;margin-left: -295px;">
                ...
                <div class="have-material clearfix img-list">
                    ...
                    <div class="col-lg-3 img-warp" v-if="data.length"  v-for="(item,index) in data">
                        ...
                        <span style="margin-left: 10px;">{#item.updated_at#}</span>
