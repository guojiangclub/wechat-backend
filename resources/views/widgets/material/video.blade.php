...
<div class="col-sm-9" style="margin-top:15px;" id="showVideo-box" v-if="type=='video'&&data_img&&data_title&&selected?true:false">
    <div style="position:relative;border: 1px dashed #CCCCCC;width:300px;height:200px;">
        ...
        <div class="video_item" style="margin-left: 30px;">
            <h4>{#data_title#}</h4>
            <div class="video_area1" style="width:240px;position: absolute;bottom:20px;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="margin-top: 20px;">
                ...
                <div class="have-material clearfix img-list">
                    <div class="col-lg-4 img-text" v-if="data.length"  v-for="(item,index) in data" style="border: 0;height: 220px;" >
